...
const ManageImage =({onChooseImage})=>{
    ...
    return <Spin spinning={isLoading} >
        {contextHolder}
        <div >
            <label className="text-[14px] font-[500] mb-[2px] inline-block">Chọn hình ảnh</label>
            <div>
                <Button icon={<UploadOutlined/>} onClick={showModal}>Chọn hình ảnh</Button>
            </div>
        </div>
        <Modal title="Quản lý hình ảnh" open={isModalOpen} onOk={handleOk} onCancel={handleCancel} width={1170}>
