...
const EditLocationModal = ({ setIsShowCreateModal, isShowCreateModal,refresh,data }) => {
    ...
    const handleOk = async (values) => {
        try{
            setIsLoading(true);
            const res=await manageLocationApi.editLocation(data["_id"],{...values,promotionContent:content})
    ...
    return (
        ...
        >
            ...
            <Spin spinning={isLoading}>
                <Formik
                    initialValues={{name:data?.name||"", address:data?.address||"",email:data?.email||"",facebook_link:data?.facebook_link||"",phoneNumber:data?.phoneNumber||"",imageUrl:data?.imageUrl||"",lat:data?.lat||"",lng:data?.lng||""}}
                    ...
                    {({ values,handleSubmit,setFieldValue,errors, touched,resetForm }) => {
                        ...
                        return (<Form>
                                ...
                                <Editor
                                    ...
                                    initialValue={data?.promotionContent||""}
